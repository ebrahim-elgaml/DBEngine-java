...
public class BTree<K, V> implements Serializable {
     ...
     */
    public static final int DEFAULT_SIZE = 20; //TODO test optimal size, it has serious impact on sequencial write and read
     ...
     */
    static final class BTreeTuple<K, V> implements Serializable {
